...
class JobSeeker(models.Model):
    ...
    skill_levels = models.CharField(max_length=200, choices=LEVEL_CHOICES, default="None",blank=True, null=True)
    ...
    availability = models.CharField(max_length=50, choices=AVAILABILITY_CHOICES,default='Full Time',blank=True, null=True)
    certifications = models.ManyToManyField(Certification, blank=True,related_name='job_seeker_certifications')
    languages = models.ManyToManyField(Language, blank=True,related_name='job_seeker_languages')
    slug = models.SlugField(max_length=255, unique=True)
